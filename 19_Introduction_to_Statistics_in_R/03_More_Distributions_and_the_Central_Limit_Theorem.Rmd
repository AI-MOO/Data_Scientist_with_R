...
-   Plot the distribution of the `new_sales` `amount`s using a histogram with 10 bins.
...
`Answer:` Great work! In the current market, Amir makes sales over \$1000 about 97.7% of the time, and about 97.3% of the time in the predicted market, so there's not much of a difference. However, his average sale amount is higher in the predicted market, so the company may want to consider other metrics as well.
...
![](images/chrome_rJM65ddOi8.png){width="289"}
