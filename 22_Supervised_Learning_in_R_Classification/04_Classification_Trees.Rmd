...
![Decision Tree Plot](https://assets.datacamp.com/production/course_2906/datasets/dtree_plot.png){alt="Decision Tree Plot"}
...
![](https://assets.datacamp.com/production/course_2906/datasets/dtree_test_set.png){width="358"}
