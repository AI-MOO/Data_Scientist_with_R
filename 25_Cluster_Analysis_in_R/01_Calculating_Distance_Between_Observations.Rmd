...
1) Using consumer behavior data to identify distinct segments within a market. **✔️**

2) Predicting whether a given user will click on an ad.

3) Identifying distinct groups of stocks that follow similar trading patterns. **✔️**
...
-   None of the above, they all should be scaled when measuring distance. **✔️**
