...
![](https://assets.datacamp.com/production/course_5592/datasets/c2_e7_example.png){alt="" width="600"}
...
-   a **minimum Euclidean** distance amongst each other less than or equal to the height of the branch**✔️**
...
-   a **maximum Euclidean** distance to all other members of its cluster that is less than 40. **✔️**
